  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        _bodyText(
          context,
          "The \"News App\" provides news articles and information aggregated from reliable sources "
        ...
        _bodyText(
          ...
          "News in this app may be aggregated from various sources. "
              ...
              "If you are the content owner and wish to request removal, contact us via support email.",
        ),
        const SizedBox(height: 16),
        ...
        _bodyText(
          context,
          "Users agree not to copy, distribute, or exploit the content for commercial purposes. "
              "You must not use the app for illegal activities or actions that may harm the system.",
        ),
        const SizedBox(height: 16),
        ...
        _bodyText(
          context,
          "All source code, design, and user interface belong to the developer. "
